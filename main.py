...
def main(argv):
	...
	parser.add_argument('inputFile', help='path of the input image (screenshot)')
	parser.add_argument('outputFile', help='path for outputting the generated image')
	parser.add_argument('width', type=int, help='output image width')
	parser.add_argument('height', type=int, help='output image height')
	parser.add_argument('deviceName', help='the device frame used in the output image')
	parser.add_argument('-do', '--deviceOrientation', choices=['port', 'land'], default='port', help='the device\'s orientation on the output image')
	parser.add_argument('-t', '--text', default='', help='text displayed on the top of the output image')
	...
	parser.add_argument('-a', '--bgAlpha', type=int, default=100, help='the background\'s alpha (from 0-100) of the output image')
